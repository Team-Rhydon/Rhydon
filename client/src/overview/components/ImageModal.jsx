    ...
    <>
      ...
      <div className="i-modal-style">
        <div className="i-image-container">
          <IoIosArrowBack className="i-left-arrow" onClick={prevSlide}/>
          <IoIosArrowForward className="i-right-arrow" onClick={nextSlide}/>
          <FiMinimize className="i-minimize" onClick={() => setImageModal(false)}/>
